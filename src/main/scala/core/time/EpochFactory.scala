...
object EpochFactory {
   ...
   */
  val J2000_0: AbsoluteTime = AbsoluteTime(Date.J2000_0, Time(12, 0, TimeFormat.Zero), TimeScaleFactory.getTT)
   ...
   */
  val JULIAN: AbsoluteTime = AbsoluteTime(Date.JULIAN, Time(12, 0 , TimeFormat.Zero), TimeScaleFactory.getTT)
  /** The Unix epoch, used as the starting point for Unix timestamps.
   * Defined as January 1, 1970, at 00:00:00 UTC.
   */
  val UNIX: AbsoluteTime = AbsoluteTime(Date.UNIX, Time(0, 0, TimeFormat.Zero), TimeScaleFactory.getUTC)
  /** The CXCSEC epoch, used by the Chandra X-ray Observatory.
   * Defined as January 1, 1998, at 00:00:00 TT.
   */
  val CXCSEC: AbsoluteTime = AbsoluteTime(Date.CXCSEC, Time(0, 0, TimeFormat.Zero), TimeScaleFactory.getTT)
  /** The GPS epoch, used by the Global Positioning System.
   * Defined as January 6, 1980, at 00:00:00 UTC.
   */
  val GPS: AbsoluteTime = AbsoluteTime(Date.GPS, Time(0, 0, TimeFormat.Zero), TimeScaleFactory.getUTC)
}
